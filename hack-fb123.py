decompiled by PDM31
import os, sys
print '\x1b[1;32mMasukan ID: MR.404 dan Password: SUBSCRIBE CHANNEL MR.40R'
print '\x1b[1;32mSilahkan Login '
import os, sys

def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6282331072836&text=Assalamualaikum')
...
if sandi == 'MR.404' and user == 'MR.404':
